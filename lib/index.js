...
const LLVM_LIB_PATH = process.env.LLVM_PATH || '/usr/local/Cellar/llvm/8.0.0/lib/libLLVM';
...
const libLLVM = ffi.Library(LLVM_LIB_PATH, {
  ...
  // Builder
  'LLVMBuildAdd': [LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, 'string']],
  ...
  'LLVMBuildExactSDiv': [LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, 'string']],
  'LLVMBuildFAdd': [LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, 'string']],
  'LLVMBuildStructGEP': [LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, 'uint', 'string']],
  ...
  'LLVMBuildGlobalStringPtr': [LLVMValueRef, [LLVMBuilderRef, 'string', 'string']],
  'LLVMBuildICmp': [LLVMValueRef, [LLVMBuilderRef, 'uint', LLVMValueRef, LLVMValueRef, 'string']],
  'LLVMBuildLoad': [LLVMValueRef, [LLVMBuilderRef, LLVMTypeRef, 'string']],
  'LLVMBuildMul': [LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, 'string']],
  ...
  'LLVMBuildSub': [LLVMValueRef, [LLVMBuilderRef, LLVMValueRef, LLVMValueRef, 'string']],
